...
?>
<form action="<?php echo JRoute::_('index.php?option=com_cinemax&view=tickets&layout=modal&tmpl=component&function=' . $function);?>" method="post" name="adminForm" id="adminForm" class="form-inline">
	<fieldset class="filter clearfix">
		<div class="btn-toolbar">
			<div class="btn-group pull-left">
				<label for="filter_search">
					<?php echo JText::_('JSEARCH_FILTER_LABEL'); ?>asdasdasdasd
				</label>
			...
			<div class="btn-group pull-left">
				...
				<button type="button" class="btn hasTooltip" title="<?php echo JHtml::tooltipText('JSEARCH_FILTER_CLEAR'); ?>" data-placement="bottom" onclick="
					document.getElementById('filter_search').value='';
					document.id('filter_date_begin').value='<?php echo date('Y-m-d', strtotime(str_replace('-', '/', 'now'))) ?>';
					document.id('filter_date_end').value='<?php echo date('Y-m-d', strtotime(str_replace('-', '/', 'now'))) ?>';
					this.form.submit();">
